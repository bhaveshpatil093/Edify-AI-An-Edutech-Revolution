...
import {  LuTimer, LuBookOpen, LuFileVideo2 } from "react-icons/lu";
    ...
    <div className="border p-7 rounded-xl shadow-sm mt-3">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <div className="flex gap-2">
          <LuFileVideo2 className="text-4xl text-black" />
          <div>
        ...
        <div className="flex gap-2">
          <LuTimer className="text-4xl text-black" />
          <div>
        ...
        <div className="flex gap-2">
          <LuBookOpen className="text-4xl text-black" />
          <div>
